PROMPT 00 0. Descoberta, inventário e baseline
...
PROMPT 03 3. Docker e tamanho de imagens
Auditoria especializada, sem implementação.
...
PROMPT 04 4. Banco, ORM e conexões
Auditoria especializada, sem implementação.
...
PROMPT 05 5. Storage, disco, logs e backups
Auditoria especializada, sem implementação.
...
PROMPT 06 6. Build, deploy e CI/CD
Auditoria especializada, sem implementação.
...
PROMPT 07 7. Aplicação, framework e processos
Auditoria especializada, sem implementação.
...
PROMPT 08 8. VPS, Linux e capacidade compartilhada
Auditoria especializada, sem implementação.
...
PROMPT 09 9. Plano mestre e gate de cobertura
...
PROMPT 11 11. Validação e medição antes/depois
...
6. Gate
   ...
   PROMPT 12
7. Auditoria final independente
